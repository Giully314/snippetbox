...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	// Add a flash message in case of success of post creation.
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	// If the passed data are in valid syntax and semantic, now we need
	// to check if they correspond to valid user data.
...
func (app *application) userLogoutPost(w http.ResponseWriter, r *http.Request) {
	...
	app.sessionManager.Put(r.Context(), "flash", "You've been logget out successfully!")
